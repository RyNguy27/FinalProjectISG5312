...
GATK=../../results/05_variantCalling/gatk/mutect2_filtered.vcf.gz
GATKOUT=../../results/05_variantCalling/gatk/mutect2_norm.vcf.gz
GATKOUTAP=../../results/05_variantCalling/gatk/mutect2_normAP.vcf.gz
