...
OUTDIR=/home/FCAM/rnguyen/ISG5312/finalprojectISG5312/variants/results/05_variantCalling/gatk
mkdir -p $OUTDIR

# this was taken out because the tumors and normals have different SRR so this doesn't really match them properly
